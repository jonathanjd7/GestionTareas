  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h2 className="text-xl font-semibold text-blue-800 mb-4 ">
        {tareaEditando ? 'Editar Tarea:' : 'Agregar Tarea:'}
      </h2>
      
      <div className="space-y-2 text-black">
        <label htmlFor="titulo" className="block text-sm font-medium text-blue-700">
          Título:
        </label>
      ...
      <div className="space-y-2 text-black">
        ...
        <textarea
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-700"
